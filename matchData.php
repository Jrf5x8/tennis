<?php
    ...
    $query = "SELECT matches.id, p1.fname as 'you', p2.fname
                ...
                JOIN person p2 ON p2.id = matches.player2 WHERE matches.player1 = (SELECT id FROM person WHERE fname = '$username') AND                           matches.tournID = (SELECT id FROM tournaments WHERE name = '$tourney')";
